...
export class OllamaModelService implements IModelService {
  ...
  private async create(): Promise<void> {
    this.model = new ChatOllama({
      model: 'qwen3-coder-next:cloud',       //en cloud, para testear: qwen3-coder-next:cloud //qwen2.5:1.5b aun mas rapido // llama3.2:3b rápido para chat //qwen3.5:4b más preciso para tareas complejas

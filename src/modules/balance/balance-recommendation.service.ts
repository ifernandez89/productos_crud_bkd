...
export class BalanceRecommendationService {
  ...
  async processRecommendations(
    ...
    this.logger.log(`[balance-recommendation] Procesando y validando recomendaciones para el reporte`);
    ...
    return {
      accionFocalizada: recommendations.accionFocalizada || 'Elegí un aspecto en el cual enfocarte hoy y da un paso concreto.',
      preguntaReflexion: recommendations.preguntaReflexion || '¿Qué estás evitando ver en este momento de tu vida?',
      semilla: semilla || '🌱 Elegí una sola acción que represente la manifestación de aquello que ya sabés. No busques más información. Construí.',
    };
  }
}
